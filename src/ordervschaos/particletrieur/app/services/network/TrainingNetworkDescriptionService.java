...
public class TrainingNetworkDescriptionService {
    ...
    public static void addDefaultInputSize(TrainingLaunchInfo info, int height, int width, int channels) {
        info.imageHeight = height;
        info.imageWidth = width;
        info.imageChannels = channels;
    }

    public static List<TrainingLaunchInfo> getDescriptions() {

        ArrayList<TrainingLaunchInfo> networkInfos = new ArrayList<>();

        TrainingLaunchInfo cnn = new TrainingLaunchInfo();
