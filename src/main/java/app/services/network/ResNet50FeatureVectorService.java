...
public class ResNet50FeatureVectorService {
    ...
    public ResNet50FeatureVectorService() {
        ...
        info.protobuf =  "resources/trained_networks/feature_vector/frozen_model.pb";
        info.type = "vector";
