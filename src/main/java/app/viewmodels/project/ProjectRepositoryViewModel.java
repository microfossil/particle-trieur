package main.java.app.viewmodels.project;

import main.java.app.App;
import main.java.app.controls.BasicDialogs;
import main.java.app.models.ProjectRepository;
...
import main.java.app.viewmodels.MainViewModel;
...
public class ProjectRepositoryViewModel {
    ...
    public boolean showIfProjectNeedsSave(String message) {
        if (supervisor.project.getIsDirty()) {
            ...
            Image image = new Image(App.class.getResourceAsStream("resources/icon.png"), 44, 44, true, true);
